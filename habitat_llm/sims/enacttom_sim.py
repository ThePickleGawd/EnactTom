...
@registry.register_simulator(name="EnactToMSim-v0")
class EnactToMSim(RearrangeSim):
    ...
    def initialize_object_state_machine(self, ep_info: "EnactToMEpisode") -> None:
        """
        Initializes the internal ObjectStateMachine such that MangedObjects can have mutable states.
        Sets the initial object state values defined in the EnactToMEpisode

        :param ep_info: The EnactToMEpisode optionally containing initial values for object states.
        """
    ...
    def reconfigure(
        self, config: "DictConfig", ep_info: "EnactToMEpisode"
    ) -> None:
